...
| Barbarian | **Warlord's Might** | Two-handed swords cost 2 less strength to equip. |
...
Sacrifice, Barkskin · Minions: Skeleton (capacity 3, 2 free).
...
### Barbarian — *THE WARLORD* · badge SPECIALIST — req **STR 15 · CON 2 (OVER-DEMAND, see note)**
...
**Over-demand is the identity (flagged, tune later):** fully-active STR = claymore 3 (5−2 Warlord's
Might) + plate 8 + Cleave 2 + Bind 2 = 15 — no race reaches it (max Half-Giant 6+4=10). The Warlord
ships more iron than he can hold and the player TRIAGES via the §6e cascade — the 02 ref itself shows
kit pieces DISABLED. Engine consequence: the "every core activates its whole default kit" test must
EXEMPT barbarian (assert instead: fights and wins with its sustainable subset).
