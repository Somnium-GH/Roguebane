...
public partial class Game1 : Microsoft.Xna.Framework.Game
{
        ...
        Color? tint = null, bool allowBare = true)
    {
        ...
        {
            // §6e paper-doll = capability truth: a DISABLED hand item (broken arm OR stat
            // below its reserve) never draws — it stays only on the red Equipment card.
            if (!body.HandItemUsable(i)) continue;
            var w = body.Hands[i];
