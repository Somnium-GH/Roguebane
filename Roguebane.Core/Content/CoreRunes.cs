...
public static class CoreRunes
{
    ...
    public static readonly CoreRune Grunt = new(
        ...
        ApexName: "Hollow Vessel",
        ApexDesc: "Unspent rune budget converts live into a regenerating resource.");
    ...
    public static readonly CoreRune Adept = new(
        ...
        ApexName: "Overchannel",
        ApexDesc: "Spells hit far harder while the head holds - but burn you as they cast.");
    ...
    public static readonly CoreRune Warden = new(
        ...
        ApexName: "Unbroken Aegis",
        ApexDesc: "The held shield never fully breaks while the chest still stands.");
    ...
    public static readonly CoreRune Summoner = new(
        ...
        ApexName: "Legion",
        ApexDesc: "Every filled bay strengthens the whole war-party at once.");
    ...
    public static readonly CoreRune Reaver = new(
        ...
        ApexName: "Bloodrush",
        ApexDesc: "Each part you break quickens your next strike.");
    ...
    public static readonly CoreRune Ranger = new(
        ...
        ApexName: "Piercing Focus",
        ApexDesc: "A held aim sharpens every shot into the same wound.");
